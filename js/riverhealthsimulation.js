class RiverHealthSimulation {
    ...
    initVis() {
        ...
        vis.fish1.append("image")
           ...
           .attr("width", 250 * svgTransitions.master_scale_width)
           .attr("height", 250 * svgTransitions.master_scale_height);
        ...
        vis.fish2.append("image")
            ...
            .attr("width", 50*svgTransitions.master_scale_width)
        ...
        vis.svg
            ...
            .attr("x", 0*svgTransitions.master_scale_width)
            .attr("y", 60*svgTransitions.master_scale_height)
            .attr("height", 11 * svgTransitions.master_scale_height)
            .attr("width", vis.width);
        ...
        vis.svg
            ...
            .attr("height", 420 * svgTransitions.master_scale_height)
            .attr("width", vis.width);
    ...
    updateVis() {
        ...
        let sealife_left_margin = 380*svgTransitions.master_scale_width;
        let sealife_center_height = 55*svgTransitions.master_scale_height;
        ...
        if (vis.nutrientsState > 0) { //show nutrients added after that stage
            vis.svg
                ...
                .style('fill', 'darkred')
                .style('opacity', 0.2)
                .attr("cx", (-150 + sealife_left_margin)*svgTransitions.master_scale_width)
                .attr("cy", (sealife_center_height+130) * svgTransitions.master_scale_height)
                .attr("r", 110 * svgTransitions.master_scale_width)

            vis.svg
                .append("image")
                .attr("href", "img/icon_phosphorus.png")
                .attr("x", (-200 + sealife_left_margin)*svgTransitions.master_scale_width)
                .attr("y", (sealife_center_height+80)*svgTransitions.master_scale_height)
                .attr("width", 100 * svgTransitions.master_scale_height)
                .attr("height", 100 * svgTransitions.master_scale_height)
                    ...
                    vis.tooltip
                        ...
                        .html(`
                                           <!--  <div style="border: thin solid #c6c6c6; width: 110%; border-radius: 5px; background: #ffffff; padding: 10px; text-align: left"> -->
                                                ...
                                                <h4 style="color:white">Nutrient Runoff</h4>   
                                                <b>Phosphorus Pollution</b>
        ...
        if (vis.temperatureState > 0) { //show temperature - medium
            vis.svg
                ...
                .style('fill', 'gold')
                .style('opacity', 0.2)
                .attr("cx", (-250 + sealife_left_margin)*svgTransitions.master_scale_width)
                .attr("cy", (sealife_center_height+250)*svgTransitions.master_scale_height)
                .attr("r", 110 * svgTransitions.master_scale_width)

            vis.svg
                .append("image")
                .attr("href", "img/icon_temperature.png")
                .attr("x", (-293 + sealife_left_margin)*svgTransitions.master_scale_width)
                .attr("y", (sealife_center_height+200)*svgTransitions.master_scale_height)
                .attr("width", 100*svgTransitions.master_scale_height)
                .attr("height", 100*svgTransitions.master_scale_height)
                .on('mouseover', function(event, d){  /// TOOLTIP FUNCTIONALITY
                    d3.select(this)
        ...
        if (vis.temperatureState > 1) { //show temperature - high
            vis.svg
                ...
                .style('fill', 'gold')
                .style('opacity', 0.2)
                .attr("cx", (-50 + sealife_left_margin)*svgTransitions.master_scale_width)
                .attr("cy", (sealife_center_height+250)*svgTransitions.master_scale_height)
                .attr("r", 110*svgTransitions.master_scale_width)
            ...
            vis.svg
                .append("image")
                .attr("href", "img/icon_temperature.png")
                .attr("x", (-93 + sealife_left_margin)*svgTransitions.master_scale_width)
                .attr("y", (sealife_center_height+200)*svgTransitions.master_scale_height)
                .attr("width", 100*svgTransitions.master_scale_height)
                .attr("height", 100*svgTransitions.master_scale_height)
                .on('mouseover', function(event, d){  /// TOOLTIP FUNCTIONALITY
        ...
        if (vis.wetlandState > 0) { //show wetland
            vis.svg.append('g') //floating wetland
                ...
                .attr("transform", 'translate ('+(1200*svgTransitions.master_scale_width)+','+(60*svgTransitions.master_scale_height)+')')
                .on('mouseover', function(event, d){  /// TOOLTIP FUNCTIONALITY
                    d3.select(this)
                    vis.tooltip
                        .style("opacity", 0.89)
                        ...
                        .html(`
                                          <!--   <div style="border: thin solid #c6c6c6; width: 110%; border-radius: 5px; background: #ffffff; padding: 10px; text-align: left"> -->
                                              <div class="sim-tooltip">  
                                                 <h4 style="color:white">Floating Wetland</h4>    
                                                 <b>Wetland Roots Provide Protection for Zooplankton against Small Fish.</b>
                                             </div>`);
                })
                .on('mouseout', function(event, d) {
                    d3.select(this)
            ...
            vis.svg.selectAll("#floatingWetlandCluster")
                ...
                .attr("transform", 'translate (0,0) scale('+(4*svgTransitions.master_scale_width)+','+(4.5*svgTransitions.master_scale_height)+')')
            vis.svg.selectAll("#floatingWetlandCluster")
                .append('path')
                .attr("id", "floatingWetlandRoots")
                .style('fill', vis.elementSvgPaths[3].color)
                .attr("d", vis.elementSvgPaths[3].path)
                .attr("transform", 'translate (0,0) scale('+(4*svgTransitions.master_scale_width)+','+(10*svgTransitions.master_scale_height)+')')
                .style('opacity', 0.60)
        }
        ...
        vis.svg
            ...
            .attr("x", (0 + sealife_left_margin-50)*svgTransitions.master_scale_width)
            .attr("y", (sealife_center_height-100)*svgTransitions.master_scale_height)
            .attr("width", 550*svgTransitions.master_scale_height)
            .attr("height", 550*svgTransitions.master_scale_height)
            .style("opacity", 0)
            .on('mouseover', function(event, d){  /// TOOLTIP FUNCTIONALITY
                d3.select(this)
                vis.tooltip
                    ...
                    .html(`
                                          <!--   <div style="border: thin solid #c6c6c6; width: 110%; border-radius: 5px; background: #ffffff; padding: 10px; text-align: left"> -->
                                                <div class="sim-tooltip">
                                                 <h4 style="color:white">Big Fish</h4>    
                                                 <b>Big Fish eat Small Fish</b></br> 
                                                 They need high oxygen levels to survive
                                             </div>`);
            })
            .on('mouseout', function(event, d) {
                d3.select(this)
        ...
        vis.svg
            ...
            .attr("x", (380 + sealife_left_margin)*svgTransitions.master_scale_width)
            .attr("y", (sealife_center_height-40)*svgTransitions.master_scale_height)
            .attr("width", 450*svgTransitions.master_scale_height)
            .attr("height", 450*svgTransitions.master_scale_height)
            .style("opacity", 0)
            .on('mouseover', function(event, d){  /// TOOLTIP FUNCTIONALITY
                    d3.select(this)
                    vis.tooltip
                        ...
                        .html(`
                                           ...
                                           <!--  <div style="border: thin solid white; width: 110%; border-radius: 5px; background: black; padding: 12px; text-align: left"> -->
                                             <div class="sim-tooltip">
                                                 <h4 style="color:white">Small Fish</h4>    
        ...
        vis.svg
            ...
            .attr("x", (750 + sealife_left_margin)*svgTransitions.master_scale_width)
            .attr("y", (sealife_center_height-20)*svgTransitions.master_scale_height)
            .attr("width", 500*svgTransitions.master_scale_height)
            .attr("height", 420*svgTransitions.master_scale_height)
            .style("opacity", 0)
            .on('mouseover', function(event, d){  /// TOOLTIP FUNCTIONALITY
                d3.select(this)
                vis.tooltip
                    ...
                    .html(`
                                            <!-- <div style="border: thin solid #c6c6c6; width: 110%; border-radius: 5px; background: #ffffff; padding: 10px; text-align: left"> -->
                                                <div class="sim-tooltip">   
                                                 <h4 style="color:white">Zooplankton</h4>    
                                                 <b>Zooplankton eat Cyanobacteria</b></br>Their ideal natural habitat is wetland marshes
                                             </div>`);
            })
            .on('mouseout', function(event, d) {
                d3.select(this)
        ...
        vis.svg
            ...
            .attr("x", (1180 + sealife_left_margin)*svgTransitions.master_scale_width)
            .attr("y", (sealife_center_height+22)*svgTransitions.master_scale_height)
            .attr("width", 350*svgTransitions.master_scale_height)
            .attr("height", 350*svgTransitions.master_scale_height)
            .style("opacity", 0)
            .on('mouseover', function(event, d){  /// TOOLTIP FUNCTIONALITY
                d3.select(this)
                vis.tooltip
                    ...
                    .html(`
                                           <!--  <div style="border: thin solid #c6c6c6; width: 110%; border-radius: 5px; background: #ffffff; padding: 10px; text-align: left"> -->
                                             <div class="sim-tooltip">
                                                 <h4 style="color:white">Cyanobacteria</h4>
                                                 <b>The problem we are trying to solve.</b></br> 
                                                 Cyanobacteria (Blue Green Algae)create toxic floating green blooms on the river's surface
    ...
    transitionBackgroundEnter() {
        ...
        vis.cloud.transition().duration(40000).attr("transform", "translate("+(3000*svgTransitions.master_scale_width)+", 0)");
        vis.fish1.transition().duration(15000).attr("transform", "translate("+(3000*svgTransitions.master_scale_width)+", 0)");
        vis.fish2.transition().duration(25000).attr("transform", "translate("+(3000*svgTransitions.master_scale_width)+", 0)");
    }
