class titleCardOneGraphics {
    ...
    initVis() {
        ...
        vis.svg.select("#backgroundRiverAnimationWaveCrest1")
            ...
            .attr('fill', '#703d0f')//starting color
            .attr("opacity", 1.0)
        ...
        vis.svg.select("#backgroundRiverAnimationWave1")
            .append('path')
            // .attr('class', 'parallax-single')
            .attr('fill', '#935116')//starting color
            .attr("opacity", 1.0)
            .attr("d", vis.svgPaths[0].path)
        ...
        vis.detailTextTitleCardOne
            ...
            .html(`
                        <div class="row justify-content-center backgroundTransparentWhiteFill">
                            ...
                            <p class="subjectDetailText" style="margin-top: 20px; font-size: 22px;"></br>In water bodies like rivers, sewage contamination poses a serious threat to swimability. Fecal matter can carry a variety of pathogens, including Giardia, Salmonella, and Hepatitis, that can make swimmers sick.</p>
                            ...
                            <p class="subjectDetailText" style="margin-top: 20px; font-size: 22px;">In Massachusetts, the Department of Public Health sets safety standards for E. coli levels. If a water body exceeds these thresholds, the area is considered unsafe to swim.</p>
